...
let question3 = `Wie bindet man eine Website in eine Website ein?`;
let question3Answer1 = `&lt;iframe&gt;, &lt;frame&gt, and &lt;frameset&gt`;
let question3Answer2 = `&lt;iframe&gt;`;
let question3Answer3 = `&lt;frame&gt;`;
let question3Answer4 = `&lt;frameset&gt;`;
...
function loadQuestion3() {
    ...
    document.getElementById(`answer1`).innerHTML = question3Answer1;
    document.getElementById(`answer2`).innerHTML = question3Answer2;
    document.getElementById(`answer3`).innerHTML = question3Answer3;
    document.getElementById(`answer4`).innerHTML = question3Answer4;
    rightAnswer = 2;
}